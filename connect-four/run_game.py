...
# for i in range(0,2):
#     minimax_ply_2 = minimaxHeuristic(1,3)
#     minimax_ply_4 = minimaxHeuristic(2,4)
#     str_random = random(gamenum=1)
#     if i%2 == 0:
#         minimax_ply_2.player = 1
#         minimax_ply_4.player = 2
#         a = Game(minimax_ply_2,str_random)
#     else:
...
for i in range(0,500):
    ...
    str_manual = manual()
    if i%2 == 0:
        str_lastminute = lastMinute(1,i)
        str_minimax_2 = minimaxHeuristic(2,4)
        a = Game(str_lastminute, str_minimax_2)
        order = {'Tie':'Tie', 2: 'mini', 1:'last'}
    else:
        str_lastminute2 = lastMinute(2,i)
        str_minimax = minimaxHeuristic(1,4)
